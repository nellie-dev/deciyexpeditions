!function(e, t) {
    ...
    "use strict";
    var t, n, o, r, a = {}, u = "querySelector"in document && "addEventListener"in e, c = {
    ...
    a.animateScroll = function(t, n, a) {
        ...
        var l = "#" === n ? e.document.documentElement : e.document.querySelector(n)
          , v = e.pageYOffset;
        o || (o = e.document.querySelector(s.selectorHeader)),
        r || (r = b(o));
        var y, O, S, I = m(l, r, parseInt(s.offset, 10)), H = I - v, E = h(), L = 0;
        g(n, s.updateURL);
        var j = function(o, r, a) {
            var u = e.pageYOffset;
            (o == r || u == r || e.innerHeight + u >= E) && (clearInterval(a),
            l.focus(),
            s.callback(t, n))
        }
          , w = function() {
    ...
    var v = function(e) {
        ...
        n && "a" === n.tagName.toLowerCase() && (e.preventDefault(),
        a.animateScroll(n, n.hash, t))
    }
      , y = function(e) {
    ...
    return a.destroy = function() {
        t && (e.document.removeEventListener("click", v, !1),
